...
//corresponds to the SRP principle, because it only performs adding to Storage and no other purposes
//if we need to add one more Myth of Story we dont need to change anything
